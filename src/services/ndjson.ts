 ...
 *
 * ACP runs over the Codex adapter's stdio as one JSON object per line; this codec is the only
...
/** Encodes one ACP NDJSON line for the Codex adapter's stdin pipe. */
